...
// ASP.NET Core Backend Base URL (Railway Production Cloud - Live API)
const API_BASE_URL = import.meta.env.VITE_API_URL || 'https://eventmanagementproject-production-19c1.up.railway.app/api';
